  ...
  const stopListening = async () => {
    ...
    if (currentMessage) {
      ...
      try {
        ...
        const response = await axios.post('https://checking-database.onrender.com/request_query', { requery: currentMessage });
  ...
  return (
    <div className="app-container flex flex-col min-h-screen">
      ...
      <main className="main-content flex-grow flex items-center justify-center bg-gray-100 p-4">
        <div className="chat-box bg-white rounded-lg shadow-lg p-4 w-full max-w-4xl align-center justify-center">
          <div className="flex flex-col md:flex-row align-center justify-center">
           
            <div className="w-full md:w-1/2 flex flex-col justify-between">
            <div className="message-list p-4 border-b border-gray-200 flex-grow overflow-y-auto max-h-20">
        ...
        <div className="mb-2">
          <strong>User (current):</strong> {currentMessage}
              ...
              <div className="actions mt-4 flex flex-col items-center">
                ...
                >
                  {isRecording ? "Fire Query 🔥" : "Start Speaking Query 🔥"}
                </button>
              </div>
            </div>
          </div>
          {employees.length > 0 && (
  <div className="employee-table mt-8 overflow-x-auto">
